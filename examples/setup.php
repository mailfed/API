<?php
/**
 * This file contains an example of base setup for the MailFedApi PHP-SDK.
 *
...
require_once dirname(__FILE__) . '/../MailFedApi/Autoloader.php';
 ...
 * If the MailFed powered website doesn't use clean urls, 
 * make sure your apiUrl has the index.php part of url included, i.e: 
 * http://www.mailfed-powered-website.tld/api/index.php
 * 
 * Configuration components:
 * The api for the MailFed EMA is designed to return proper etags when GET requests are made.
 ...
 * Please see MailFedApi/Cache for a list of available cache components and their usage.
 */

// configuration object
$config = new MailFedApi_Config(array(
    'apiUrl'        => 'http://www.mailfed-powered-website.tld/api',
    ...
    'components' => array(
        'cache' => array(
            'class'     => 'MailFedApi_Cache_File',
            'filesPath' => dirname(__FILE__) . '/../MailFedApi/Cache/data/cache', // make sure it is writable by webserver
        )
    ),
));

// now inject the configuration and we are ready to make api calls
MailFedApi_Base::setConfig($config);
