...
if ($isAjaxRequest && !empty($_POST)) {
    ...
    $endpoint   = new MailFedApi_Endpoint_ListSubscribers();
    ...
    if ($response->itemAt('status') == 'success') {
        exit(MailFedApi_Json::encode(array(
            'status'    => 'success',
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://www.mailfed.com/backend/assets/css/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="http://www.mailfed.com/backend/assets/css/bootstrap-glyphicons.css" />
    <link rel="stylesheet" type="text/css" href="http://www.mailfed.com/backend/assets/css/style.css" />
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    <script type="text/javascript" src="http://www.mailfed.com/backend/assets/js/bootstrap.js" id="script-bootstrap"></script>
    <link rel="shortcut icon" href="http://www.mailfed.com/favicon.ico" type="image/x-icon" /> 
...
<div class="col-lg-4" id="content">
    <!--
    The form below is generated by MailFed EMA.
