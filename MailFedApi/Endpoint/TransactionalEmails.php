<?php
/**
 * This file contains the transactional emails endpoint for MailFedApi PHP-SDK.
 * 
...
/**
 * MailFedApi_Endpoint_TransactionalEmails handles all the API calls for transactional emails.
 * 
 * @author Serban George Cristian 
 * @package MailFedApi
 * @subpackage Endpoint
 * @since 1.0
 */
class MailFedApi_Endpoint_TransactionalEmails extends MailFedApi_Base
{
    /**
