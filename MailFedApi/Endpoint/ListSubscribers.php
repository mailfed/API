<?php
/**
 * This file contains the lists subscribers endpoint for MailFedApi PHP-SDK.
 * 
...
/**
 * MailFedApi_Endpoint_ListSubscribers handles all the API calls for lists subscribers.
 * 
 * @author Serban George Cristian 
 * @package MailFedApi
 * @subpackage Endpoint
 * @since 1.0
 */
class MailFedApi_Endpoint_ListSubscribers extends MailFedApi_Base
{
    /**
