<?php
/**
 * This file contains the File cache class used in the MailFedApi PHP-SDK.
 * 
...
/**
 * MailFedApi_Cache_File makes use of the file system in order to cache data.
 * 
 * @author Serban George Cristian 
 * @package MailFedApi
 * @subpackage Cache
 * @since 1.0
 */
class MailFedApi_Cache_File extends MailFedApi_Cache_Abstract
{
    /**
