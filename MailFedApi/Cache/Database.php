<?php
/**
 * This file contains the Database cache class used in the MailFedApi PHP-SDK.
 * 
...
/**
 * MailFedApi_Cache_Database makes use of the PHP's {@link PDO} extension in order to cache data into a database.
 * 
 ...
 * @since 1.0
 */
class MailFedApi_Cache_Database extends MailFedApi_Cache_Abstract
{
    /**
     ...
     * @return MailFedApi_Cache_Database
     */
