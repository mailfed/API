<?php
/**
 * This file contains the APC cache class used in the MailFedApi PHP-SDK.
 * 
...
/**
 * MailFedApi_Cache_Xcache makes use of the xcache extension in order to cache data in memory.
 * 
 ...
 * @since 1.0
 */
class MailFedApi_Cache_Xcache extends MailFedApi_Cache_Abstract
{
    /**
