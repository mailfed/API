<?php
/**
 * This file contains the MailFedApi_Http_Client class used in the MailFedApi PHP-SDK.
 * 
...
/**
 * MailFedApi_Http_Client is the http client interface used to make the remote requests and receive the responses.
 * 
 * @author Serban George Cristian 
 * @package MailFedApi
 * @subpackage Http
 * @since 1.0
 */
class MailFedApi_Http_Client extends MailFedApi_Base
{
    /**
    ...
    /**
     * @var MailFedApi_Params the GET params sent in the request.
     */
    public $paramsGet = array();
    
    /**
     * @var MailFedApi_Params the POST params sent in the request.
     */
    public $paramsPost = array();
    
    /**
     * @var MailFedApi_Params the PUT params sent in the request.
     */
    public $paramsPut = array();
    
    /**
     * @var MailFedApi_Params the DELETE params sent in the request.
     */
    public $paramsDelete = array();
    
    /**
     * @var MailFedApi_Params the headers sent in the request.
     */
    ...
    public function __construct(array $options = array())
    {
        ...
        foreach (array('paramsGet', 'paramsPost', 'paramsPut', 'paramsDelete', 'headers') as $param) {
            if (!($this->$param instanceof MailFedApi_Params)) {
                $this->$param = new MailFedApi_Params($this->$param);
            }
        }
    }
    ...
    {
        $request = new MailFedApi_Http_Request($this);
