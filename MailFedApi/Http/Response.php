<?php
/**
 * This file contains the MailFedApi_Http_Response class used in the MailFedApi PHP-SDK.
 * 
...
/**
 * MailFedApi_Http_Response is the class used to get the responses back from the API endpoints.
 * 
 * @author Serban George Cristian 
 * @package MailFedApi
 * @subpackage Http
 * @since 1.0
 */
class MailFedApi_Http_Response extends MailFedApi_Base
{
    /**
    ...
    /**
     * @var MailFedApi_Params $headers the headers that came back in the response.
     */
    public $headers;
    ...
    /**
     * @var MailFedApi_Params $curlInfo the curl info returned in the response.
     */
    public $curlInfo;
    
    /**
     * @var MailFedApi_Params $body the body of the response.
     */
    public $body;
     ...
     * Contructor.
     * 
     * @param MailFedApi_Http_Request $request
     */
    public function __construct(MailFedApi_Http_Request $request)
    {
    ...
    public function populate(array $params = array())
    {
        if ($this->storeCurlInfo) {
            $this->curlInfo = new MailFedApi_Params($params);
        }
